...
//changed this to 250 from 350	
	...
	fin.push_back("/afs/cern.ch/work/m/mhadley/public/for_DoubleBGroup/Final_histograms_sysMerged_PtRange250to350_plain_old_JP.root");
	fout.push_back("SFtemplates/"+date+"/plainJP_PtRangeIs250to350"+dataJPcalib+"_SysMerged_SFtemplates");
