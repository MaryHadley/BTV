...
//    Float_t nReBin = 1.;
   ...
   for(int ifile=0; ifile<fin.size();ifile++){
	   ...
	   fout_ = fout.at(ifile)+"_DeepDoubleX"+WP+kScaleStr+".root"; //Mary changed this from _DoubleB to _DeepDoubleX
	   fNew = TFile::Open(fout_,"RECREATE");
	   std::cout<< "Creating file: "<< fout_ << std::endl;

	   std::string tag; 
	   tag = "DeepDoubleX"+WP; //was DoubleB, has to match what your branch name is
...
void convert(){
	TString date = "Jan2018"; //dataJPcalib with ALl sys copied. SVmass=JPhasSV. fixed normalization v4, post,untag of JPhas,JPnoSV,SVmass take norm from pre of JP.
...
//*/ //might need this later
	...
	fin.push_back("/afs/cern.ch/work/m/mhadley/public/for_DoubleBGroup/Final_histograms_sysMerged_fatJetPtMinIs350_DDX_plain_old_JP.root");
	fout.push_back("SFtemplates/"+date+"/plainJP_PtMinIs350"+dataJPcalib+"_SysMerged_SFtemplates");
	varName.push_back("JP"); //JP must always be first. (Because all histo scaling is based on JP pre tag histos)

	fin.push_back("/afs/cern.ch/work/m/mhadley/public/for_DoubleBGroup/Final_histograms_sysMerged_FatJetPtMinIs350_DDX_SVMass_the_good_one_USETHIS.root");
	fout.push_back("SFtemplates/"+date+"/JPhasSV_PtMinIs350"+dataJPcalib +"_SysMerged_SFtemplates");
 	varName.push_back("JPhasSV"); 
// 
 	fin.push_back("/afs/cern.ch/work/m/mhadley/public/for_DoubleBGroup/Final_histograms_sysMerged_FatJetPtMinIs350_DDX_jpNOsv.root");
 	fout.push_back("SFtemplates/"+date+"/JPhasNOSV_PtMinIs350"+dataJPcalib +"_SysMerged_SFtemplates");
 	varName.push_back("JPnoSV");
// 
 	fin.push_back("/afs/cern.ch/work/m/mhadley/public/for_DoubleBGroup/Final_histograms_sysMerged_fatJetPtMinIs350_DDX_SVmass.root");
 	fout.push_back("SFtemplates/"+date+"/SVmass_PtMinIs350"+dataJPcalib+"_SysMerged_SFtemplates");
