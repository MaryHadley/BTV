...
# ./createAndSubmitJobs_new.py -w Mu_350_bfragup -e true -o $eospath -c btagvalidation_cfg.py -d txt_forJobSubmits/rizki_SF_80x_DoubleMuonTag_QCDMuEnriched_BTagMu_mcJPcalib_HLTAK8Jet300_OR_HLTJet300_pt350_bfragup.txt -q cmscaf1nh #8nh
